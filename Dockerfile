...
# node_modules + source (21s amd64 / 222s arm64 — #49113).  0755 gives
# the non-root hermes user read + traverse but no write; root retains
...
# read-only for the hermes user (0755 from the --chmod above).
